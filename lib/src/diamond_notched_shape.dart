...
class DiamondNotchedAndCorneredRectangle extends NotchedShape {
  ...
  DiamondNotchedAndCorneredRectangle({
  ...
  Path getOuterPath(Rect host, Rect? guest) {
    ...
    return Path()
      ...
      ..lineTo(host.right / 2 - 50, host.top)
      ..lineTo(host.right / 2 - 12, host.top + 38)
      ..arcToPoint(Offset(host.right / 2 + 12, host.top + 38), radius: Radius.circular(24), clockwise: false)
      ..lineTo(host.right / 2 + 50, host.top)
      ..lineTo(host.right - rightCornerRadius, host.top)
      ..arcToPoint(
        Offset(host.right, host.top + rightCornerRadius),
